...
\sectionline
	...
	\begin{tabular}{@{}p{7cm}p{1.0cm}p{7cm}}
	    % Jupyter Disqus
    	\begin{tabular}[t]{@{}l@{}}
    	    \textbf{\listing Jupyter Disqus (Python)} \\ 
    	...
    	\begin{tabular}[t]{@{}l@{}}
    	    \textbf{\listing LP Optimization (Python)} \\ 
    	...
    	% Parallax Template
        \begin{tabular}[t]{@{}l@{}}
    	    \textbf{\listing Parallax Template (JavaScript)} \\ 
    	...
    	% Penspider
    	\begin{tabular}[t]{@{}l@{}}
    	    \textbf{\listing Penspider (Python)} \\ 
